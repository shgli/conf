...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/shgli/.eclipse/org.eclipse.platform_3.7.0_419062069/plugins/org.eclim_1.7.1'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/shgli/.eclipse/org.eclipse.platform_3.7.0_419062069'
  if has('win32unix')
